...
{
    /// <inheritdoc />
    public partial class EditModelsNotNull : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                newName: "IX_AppUserRole_UserId_RoleId_MarkazId");
            ...
            migrationBuilder.AlterColumn<DateOnly>(
                name: "TarikheShorooMojavezMarakez",
                table: "Terms",
                type: "date",
                nullable: true,
                oldClrType: typeof(DateOnly),
            ...
            migrationBuilder.AlterColumn<DateOnly>(
                name: "TarikhePayanMojavezMarakez",
                table: "Terms",
                type: "date",
                nullable: true,
                oldClrType: typeof(DateOnly),
            ...
            migrationBuilder.AlterColumn<string>(
                name: "ShomareGozarnameYaKartHoviyat",
                table: "Daneshjoos",
                type: "nvarchar(50)",
                maxLength: 50,
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "ShenasayeFaragirAtbaaKhareji",
                table: "Daneshjoos",
                type: "nvarchar(50)",
                maxLength: 50,
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "CodeReshteMahalGhabooliSanjesh",
                table: "Daneshjoos",
                type: "nvarchar(50)",
                maxLength: 50,
                nullable: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[CodeOstad] IS NOT NULL AND [CodeTerm] IS NOT NULL AND [MarkazId] IS NOT NULL AND [Tarikh] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[CodeOstad] IS NOT NULL AND [CodeTerm] IS NOT NULL AND [MarkazId] IS NOT NULL AND [RoozeHafteh] IS NOT NULL");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "AspNetUserRoles",
                newName: "IX_AspNetUserRoles_UserId_RoleId_MarkazId");
