...
namespace PayamBack.Migrations
{
    ...
    [Migration("20260814144849_ChangeSizePositionInSignature")]
    partial class ChangeSizePositionInSignature
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayamBack.Models.Schedule.ElmiTerm", b =>
                {
                    ...
                    b.HasIndex("RoleIdSabtKonandeh");

                    b.HasIndex("TermCode");

                    b.HasIndex("UserIdSabtKonandeh");

                    b.HasIndex("UserId", "TermCode")
                        .IsUnique()
                        .HasDatabaseName("IX_ElmiTerm_UserId_TermCode")
                        .HasFilter("[UserId] IS NOT NULL AND [TermCode] IS NOT NULL");
            ...
            modelBuilder.Entity("PayamBack.Models.Schedule.ElmiTerm", b =>
                {
                    ...
                    b.HasOne("PayamBack.Models.Identity.AppRole", "RoleSabtKonandeh")
                        .WithMany()
                        .HasForeignKey("RoleIdSabtKonandeh")
                        .OnDelete(DeleteBehavior.NoAction);
