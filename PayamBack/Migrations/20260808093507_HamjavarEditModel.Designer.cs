...
namespace PayamBack.Migrations
{
    ...
    [Migration("20260808093507_HamjavarEditModel")]
    partial class HamjavarEditModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PayamBack.Models.Schedule.Hamjavar1", b =>
                {
                    b.HasOne("PayamBack.Models.Schedule.Hamjavar", "Hamjavar")
                        .WithOne()
                        .HasForeignKey("PayamBack.Models.Schedule.Hamjavar1", "HamjavarId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("PayamBack.Models.Schedule.Hamjavar", null)
                        .WithMany("Hamjavar1s")
                        .HasForeignKey("HamjavarId1");
